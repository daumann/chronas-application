                                        ...
                                        callback: function (geojson) {
                                            ...
                                            if (relKing !== undefined) {
                                                ...
                                                $("#content_monA")[0].onclick = function () {
                                                    ...
                                                    $('#chronasWiki').load(function () {
                                                        if (tmpURL != 'http://en.wikipedia.org/wiki/' && tmpURL != 'http://en.wikipedia.org/wiki/?printable=yes') {
                                                            $('#loader1').hide();
                                                            $('#chronasWiki').show();
                                                            $('#notFoundNotice').hide()
                                                        } else {
...
// 
                        ...
                        if ($("#EditProvName")[0] !== undefined && allowEdit) {
                            ...
                            $( "#EditProvRel" ).change(function() {
                                if (culList.indexOf($( "#EditProvRel").val()) == -1){
                                    $( "#EditProvRel").val("");
                                }
                            });
                            ...
                            $( "#EditProvCap" ).change(function() {
                                if (capList.indexOf($( "#EditProvCap").val()) == -1){
                                    $( "#EditProvCap").val("");
                                }
                            });
                            ...
                            $( "#EditProvRel" ).change(function() {
                                if (relList.indexOf($( "#EditProvRel").val()) == -1){
                                    $( "#EditProvRel").val("");
                                }
                            });
...
// Add the year label; the value is set on transition.
    ...
    function position(dot) {
        dot.attr("cx", function (d) {
            return xScale(x(d) + 100);
        })
            .attr("cy", function (d) {
                return yScale(y(d) + 100);
            })
            .attr("r", function (d) {
...
function submitProvEdit(){
    ...
    var tmpRul=undefined;
    var tmpRel=undefined;
    var tmpCul=undefined;
    var tmpCap=undefined;
    var tmpPop=undefined;
    ...
    if($( "#EditProvRel" ).val() !== ""){
        for (var property in relPlus) {
            if (relPlus[property][0] == $( "#EditProvRel" ).val())
                tmpRel = property;
        }
    }
    ...
    if($( "#EditProvCul" ).val() !== ""){
        for (var property in culPlus) {
            if (culPlus[property][0] == $( "#EditProvCul" ).val())
                tmpCul = property;
        }
    }

    if($( "#EditProvCap" ).val() !== ""){
        tmpCap = $( "#EditProvCap" ).val();
    }

    if($( "#EditProvPop" ).val() !== ""){
        tmpPop = parseInt($( "#EditProvPop" ).val());
    }
